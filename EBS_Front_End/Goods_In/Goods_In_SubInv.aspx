<%@ Page Language="C#" AutoEventWireup="True" Inherits="Goods_In_SubInv" MasterPageFile="~/Site.Master" Codebehind="Goods_In_SubInv.aspx.cs" EnableEventValidation="false" %>
            ...
            <tr>
                ...
                <div id="goods_grid">   
                    <asp:GridView ID="GridView1" runat="server" CssClass="Grid" OnRowDataBound="GridView1_OnRowDataBound" ShowHeader="false" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" >
                        <Columns>
                            <asp:BoundField DataField="SUB INVENTORY" HeaderText="SUB INVENTORY" ItemStyle-Width="130px" />
                        </Columns>
                    </asp:GridView>
                </div>
                </td>
