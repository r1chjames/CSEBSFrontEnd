...
public partial class Goods_In_SubInv : System.Web.UI.Page
{
    private OracleConnection Connect = new OracleConnection();
    private string EBSDM13A, sql;
    ...
    {
        sql = "SELECT SECONDARY_INVENTORY_NAME AS \"SUB INVENTORY\" FROM XXPOC_SUB_INVENTORIES";
    ...
    protected void btnNext_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Session["SE_subinv"] = gridviewvalue;
            Response.Redirect("Goods_In_2.aspx", false);
            Context.ApplicationInstance.CompleteRequest();
        }
        catch (System.Exception)
        {
            showmsg("NO SUB INVENTORY SELECTED");
        }          
    }
