...
<body>
    <form id="form1" runat="server">
        <asp:ScriptManager ID="ScriptManager1" runat="server"/>
         ...
         Many queries fetch large amounts of data across the internet from the distributed servers and return it to this server located centrally. This can take some time, especially when other site wide activities are going on, such as sending large e-mails or accessing central network drives.<br />
         <br />
         <h3>I keep being taken to an error page</h3>
         Sometimes when there is a large load on the network or the database, there will be a restriction on how many users can be connected at once. There may also be temporary network connectivity issues between Hilmore House and one of the servers which may be causing these errors. In any instance, wait a few minutes and try again.<br /><br />If it persists for more than one hour you can contact the IT Service Desk, detailing what you were doing at the time, and the page you were attempting to access.<br />
         <br />
         <h3>I keep being asked to enter a username and password</h3>
         This means that you&#39;re attempting to access a part of the site that is outside of the permissions level set against your account. If you need to have access to a specific area, contact the IT Service Desk, specifying which part of the site you&#39;re attempting to access and the reasons for requiring this and we&#39;ll look at amending your access.<br />
         <br />
